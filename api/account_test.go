...
import (
	...
	mockdb "github.com/m-bashari-m/simplebank/db/mock"
...
func TestGetAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		checkRequest func(*testing.T, *httptest.ResponseRecorder)
	}{
		{
			name:      "OK",
			...
			checkRequest: func(t *testing.T, r *httptest.ResponseRecorder) {
